...
__images = {
    "alpine-hello-world": {
        "src": "alpine-hello-world/build.sh",
        "tag": "edvgui/alpine-hello-world",
        "args": {}
    },
    "alpine-http-server": {
        "src": "alpine-http-server/build.sh",
        "tag": "edvgui/alpine-http-server",
        "args": {}
    },
    "alpine-ping": {
        "src": "alpine-ping/build.sh",
        "tag": "edvgui/alpine-ping",
        "args": {}
    },
    "alpine-io-read": {
        "src": "alpine-io-read/build.sh",
